...
resource "google_compute_instance_template" "this" {
  ...
  metadata_startup_script = templatefile("${path.module}/startup.sh", { connection_name = data.terraform_remote_state.db.outputs.connection_name, server_port = var.server_port })
